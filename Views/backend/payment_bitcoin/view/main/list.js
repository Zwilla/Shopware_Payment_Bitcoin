...
Ext.define('Shopware.apps.PaymentBitcoin.view.main.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.bitcoin-main-list',
    ...
    getColumns: function() {
        ...
        return [{
            ...
            text: '{s name=list/columns/bitcoin_address_text}Bitcoin address{/s}',
            flex: 3,
            dataIndex: 'bitcoin_address'
        },{
            text: '{s name=list/columns/value_in_btc}Value in BTC{/s}',
            flex: 2,
            align: 'right',
            dataIndex: 'valueInBTC'
        },{
            text: '{s name=list/columns/total_paid_in_btc}Paid in BTC{/s}',
            flex: 2,
            align: 'right',
            dataIndex: 'total_paid_in_btc'
        },{
            text: '{s name=list/columns/bitcoin_status}Bitcoin Status{/s}',
            flex: 2,
            dataIndex: 'btcStatus'
        },{
