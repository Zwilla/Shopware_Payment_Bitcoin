...
Ext.define('Shopware.apps.PaymentBitcoin.view.main.Detail', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.bitcoin-main-detail',
    ...
    getColumns: function() {
        ...
        return [{
            ...
            text: '{s name=detail/columns/value_in_btc_text}Value in BTC{/s}',
            flex: 2,
            dataIndex: 'value_in_btc'
        }];
    }
});